...
public class Menus extends NRegister<MenuType<?>> {
    public final RegistryObject<MenuType<EnergyCounterMenu>> ENERGY_COUNTER = super.register.register("energy_counter", () -> IForgeMenuType.create(EnergyCounterMenu::new));
